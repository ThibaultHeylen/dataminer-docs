...
1. Install the database software, which can be:
   ...
   - MySQL Server
     ...
     > - To use MySQL 8.0 as offload database, an additional setting has to be done within MySQL. You need to set the local_infile to 1, as this is now default 0. To do this you can execute following command within MySQL: SET GLOBAL local_infile=1;
